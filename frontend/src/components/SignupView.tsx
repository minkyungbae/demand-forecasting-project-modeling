    ...
    <div className="flex items-center justify-center min-h-[70vh] animate-in fade-in zoom-in-95 duration-500">
      <div className="bg-white p-10 rounded-2xl shadow-xl border border-gray-100 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {error && (
            <div className="bg-red-50 text-red-500 text-xs p-3 rounded-lg border border-red-100 font-bold">
              {error}
            </div>
          )}
          ...
          <div className="space-y-1.5">
            ...
            <input 
              type="text" 
              placeholder="이름"
              className="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-primary-main focus:ring-4 focus:ring-primary-light outline-none transition-all text-sm"
          ...
          <div className="pt-2 flex flex-col gap-3">
            <button 
              type="submit"
              className="w-full bg-primary-main text-white py-3.5 rounded-xl font-black text-sm shadow-lg shadow-primary-light hover:bg-primary-dark transition-all active:scale-95"
            >
              가입하기
            </button>
          </div>
